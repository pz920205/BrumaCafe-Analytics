...
> **Nota:** Nuestra barra de café ofrece diferentes paquetes de servicio a partir de **100 bebidas en adelante**, disponibles en opciones calientes o frías.
...
Lenguajes	Python (Pandas, Numpy, Seaborn), SQL, R
Bases de Datos	MongoDB (NoSQL), MySQL, PostgreSQL
Visualización	Power BI (DAX, Dashboards Interactivos), Matplotlib
